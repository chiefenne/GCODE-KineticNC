...
export const hoverDocs: Record<string, HoverDoc> = {
  ...
  G0: {
    ...
    body: "Rapid traverse to the programmed target position.",
  },
  G1: {
    title: "G1 – Linear interpolation",
    syntax: "G1 X... Y... Z... [F...]",
    example: ["G1 X50 Y20 F200", "G1 X50 Y20", "G1 X50 Y20 Z-10"],
  ...
  G4: {
    title: "G4 – Dwell",
    syntax: "G4 H...",
    example: ["G4 H1.5", "G4 H10 UNTIL #4=1"],
    body: "Waits for the programmed time (seconds) before continuing with the next command.",
  },
  G20: {
    title: "G20 – Inch mode",
    syntax: "G20",
  ...
  G53: {
    ...
    syntax: "G53",
    body: "Uses the fixed machine coordinate system.",
  },
  G54: {
    title: "G54 – Activate zero offset 1",
    syntax: "G54",
    body: "Activates work offset memory 1.",
    notes: "X, Y, Z-coordinates of active offset stored in #900, #901, #902",
  },
  G55: {
  ...
  G64: {
    ...
    syntax: "G64",
    notes: "Same as G62 for edge rounding / polygon smoothing.",
    body: "Enables Constant Velocity mode with smoothed path transitions.",
  },
  G90: {
  ...
  G92: {
    ...
    notes:
      "E.g., set all to coordinates to 0 after homing the machine. It does not move the machine.",
  ...
  ASKBOOL: {
    ...
    example: 'ASKBOOL "Continue program execution?"',
  ...
  "#I": {
    title: "#Inn – Query input signal variable",
    syntax: "#I13",
    example: [
      "IF #I13=1 THEN\n  M2(abort, all aggregates off)\nENDIF",
      "#I[100 + #0]",
    ],
  ...
  "#O": {
    title: "#Onn – Set output signal variable",
    syntax: "#O5=1",
    example: ["#O5=1", "#O[100 + #0]"],
